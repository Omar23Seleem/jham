<div class="card shadow mb-4">
  ...
  <h6 class="m-0 font-weight-bold text-primary">Denied Applicant Accounts</h6>
  </div>
  <div class="card-body">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('DeniedAccount/ajax_list')?>",
          "type": "POST"
      },
  ...
  function activate(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo site_url('DeniedAccount/activate/'); ?>',
  ...
  function deny(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo site_url('DeniedAccount/deny/'); ?>',
        data: $('#activate').serialize(),
        success: function(data){
          Swal.fire({
            position: 'top',
