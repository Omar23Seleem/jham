<div class="card shadow mb-4">
  ...
  <h6 class="m-0 font-weight-bold text-primary">Employer Pending Accounts</h6>
  </div>
  <div class="card-body">
    ...
    <div class="modal-dialog modal-full">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Employer NSRP</h4>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('ApprovalEmp/ajax_list')?>",
          "type": "POST"
      },
  ...
  function activate(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo site_url('Approval/deny/'); ?>',
        data: $('#activate').serialize(),
        success: function(data){
          Swal.fire({
            position: 'top',
