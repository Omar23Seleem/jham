    ...
    <div class="modal-dialog modal-full">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-warning" onclick="deny()">Deactivate</button>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('AppAccount/ajax_list')?>",
          "type": "POST"
      },
  ...
  function view(id){
      ...
      $.ajax({
        url : "<?php echo site_url('Approval/get_applicant_data/')?>/" + id,
        type: "GET",
        dataType: "JSON",
  ...
  function activate(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo site_url('AppAccount/activate/'); ?>',
        data: $('#activate, $send').serialize(),
        success: function(data){
          Swal.fire({
            position: 'top',
  ...
  function deny(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo site_url('AppAccount/deny/'); ?>',
