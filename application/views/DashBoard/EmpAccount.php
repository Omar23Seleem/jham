    ...
    <div class="modal-dialog modal-full">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-warning" onclick="deny()">De-Activate</button>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $('#table').DataTable({ 
      ...
      "ajax": {
          "url": "<?php echo site_url('EmpAccount/ajax_list')?>",
          "type": "POST"
      },
  ...
  function view(id){
      ...
      $.ajax({
        url : "<?php echo site_url('EmpAccount/get_employer_data/')?>/" + id,
        type: "GET",
        dataType: "JSON",
  ...
  function activate(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo site_url('EmpAccount/activate/'); ?>',
  ...
  function deny(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo site_url('EmpAccount/deny/'); ?>',
        data: $('#activate').serialize(),
        success: function(data){
          Swal.fire({
            position: 'top',
